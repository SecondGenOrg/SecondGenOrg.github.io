			...
			<div id="footer">
				<div className="row">
					<div className="col-xs-12 col-sm-6">
						<h3>SecondGen</h3>
						<p>SecondGen is a non-profit organization which promotes entrepreneurship among students. SecondGen is a non-profit organization which promotes entrepreneurship among students. SecondGen is a non-profit organization which promotes entrepreneurship among students. SecondGen is a non-profit organization which promotes entrepreneurship among students. </p>
